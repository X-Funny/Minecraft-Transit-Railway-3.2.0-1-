...
public class MTRClient implements IPacket {
	...
	public static void init() {
		if (!Keys.LIFTS_ONLY) {
			...
			RegistryClient.registerTileEntityRenderer(BlockEntityTypes.PIDS_3_TILE_ENTITY.get(), dispatcher -> new RenderPIDS<>(dispatcher, BlockPIDS3.TileEntityBlockPIDS3.MAX_ARRIVALS, 2.5F, 10F, 6, 6.5F, 29, true, true, PIDSType.PIDS, 0xFF0000, 0xFF9900));
