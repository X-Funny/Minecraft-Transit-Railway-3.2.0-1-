...
public class MTRClient implements IPacket {
	...
	public static void init() {
		if (!Keys.LIFTS_ONLY) {
			...
			RegistryClient.registerTileEntityRenderer(BlockEntityTypes.PIDS_UCE_NANGANG_TILE_ENTITY.get(), dispatcher -> new RenderPIDS<>(dispatcher, BlockPIDSUCENANGANG.TileEntityBlockPIDSUCENANGANG.MAX_ARRIVALS, 2.5F, 10F, 6, 6.5F, 27, true, true, PIDSType.PIDS, 0xFFFF00, 0xFF0000));
			RegistryClient.registerTileEntityRenderer(BlockEntityTypes.PIDS_UCE_YEZHOU_TILE_ENTITY.get(),dispatcher -> new RenderPIDS<>(dispatcher, BlockPIDSUCEYEZHOU.TileEntityBlockPIDSUCEYEZHOU.MAX_ARRIVALS, 2.5F, 10F, 6, 6.5F, 27, true, true, PIDSType.PIDS, 0x00CC00, 0x00FF00));
