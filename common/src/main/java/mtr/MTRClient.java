...
public class MTRClient implements IPacket {
	...
	public static void init() {
		if (!Keys.LIFTS_ONLY) {
			...
			RegistryClient.registerTileEntityRenderer(BlockEntityTypes.PIDS_4_TILE_ENTITY.get(), dispatcher -> new RenderPIDS<>(dispatcher, BlockPIDS4.TileEntityBlockPIDS4.MAX_ARRIVALS, 2.5F, 10F, 6, 6.5F, 27, true, true, PIDSType.PIDS, 0xFF0000, 0xFF9900));
